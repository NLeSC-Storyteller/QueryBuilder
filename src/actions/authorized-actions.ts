...
export const LIMIT_CHANGED = 'LIMIT_CHANGED';

// Query management related
export const OPEN_CLEAR_ALL_QUERIES_DIALOG = 'OPEN_CLEAR_ALL_QUERIES_DIALOG';
export const OPEN_REBUILD_DATABASE_DIALOG = 'OPEN_REBUILD_DATABASE_DIALOG';
export const CLOSE_CLEAR_ALL_QUERIES_DIALOG = 'CLOSE_CLEAR_ALL_QUERIES_DIALOG';
export const CLOSE_REBUILD_DATABASE_DIALOG = 'CLOSE_REBUILD_DATABASE_DIALOG';
export const CLEAR_ALL_QUERIES_WAS_CLICKED = 'CLEAR_QUERY_WAS_CLICKED';
export const REBUILD_DATABASE_WAS_CLICKED = 'REBUILD_DATABASE_WAS_CLICKED';
